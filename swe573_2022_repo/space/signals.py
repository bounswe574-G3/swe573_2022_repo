...
def on_create_step(sender, instance, **kwargs):
    ...
    crt_rsc_activity = MyActivity(
        ...
        summary=f"User '{instance.resourcecreator.username}' created a step named '{instance.resourcename}' in the space '{instance.resourcespace.title}', on '{datetime.today().strftime('%d/%m/%Y, %H:%M:%S')}'",
